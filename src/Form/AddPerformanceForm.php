...
// Still at pre-confirmation, so build the main form
	...
	if (!($form_state->getStorage('confirm'))) {
      ...
      $form['booking_label'] = array(
        ...
        '#description'  =>  t('Optionally, you can define a label here that each performance\'s booking button will display'),
        '#type' =>  'textfield',
        '#states' => array(
		  'visible' => array(
			':input[name="operation"]' => array('value' => 0),
      ...
      $form['booking_url'] = array(
        '#title'  =>  t('Booking label'),
        '#description'  =>  t('You can define a URL here that each performance\'s booking button will link to'),
        '#type' =>  'textfield',
        '#states' => array(
		  'visible' => array(
			':input[name="operation"]' => array('value' => 0),
